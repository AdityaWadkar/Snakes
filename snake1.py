                ...
                if event.type == pygame.KEYDOWN:
                    ...
                    if event.key ==pygame.K_n:
                        ...
                        if songcnt == 10:
                            ...
                            pygame.mixer.music.play()
                        if songcnt == 11:
                            pygame.mixer.music.load("song11.mp3")
                            pygame.mixer.music.play()
                        if songcnt == 12:
                            pygame.mixer.music.load("song12.mp3")
                            pygame.mixer.music.play()
                        if songcnt == 13:
                            pygame.mixer.music.load("song13.mp3")
                            pygame.mixer.music.play()
